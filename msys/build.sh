...
sed -i.orig -e "/Libs:/s/$/ -lpthread/" $INSTALL_PATH/lib/pkgconfig/vpx.pc
...
sed -i.orig -e "/Cflags:/s/$/ -DKVZ_STATIC_LIB/" -e "/Libs:/s/$/ -lpthread/" $INSTALL_PATH/lib/pkgconfig/kvazaar.pc
